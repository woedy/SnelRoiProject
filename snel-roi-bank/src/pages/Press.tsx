            ...
            <div className="container mx-auto px-4 max-w-5xl">
                <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-16 border-b border-border pb-12">
                    <div className="max-w-2xl">
                        <h1 className="text-4xl md:text-6xl font-display font-bold text-primary mb-6">{t('press.hero.title')}</h1>
                ...
                <section className="grid md:grid-cols-2 gap-8 mb-20">
                    <div className="p-10 rounded-4xl bg-secondary/30 flex flex-col justify-between">
                        <div>
                            ...
                            <h2 className="text-3xl font-bold mb-4">{t('press.identity.title')}</h2>
                            <p className="text-muted-foreground mb-8 text-lg">{t('press.identity.desc')}</p>
                        </div>
                        <Button variant="link" className="text-primary font-bold p-0 justify-start text-lg">
                            {t('press.identity.btn')}
                        </Button>
                    </div>
                    <div className="p-10 rounded-4xl bg-muted flex flex-col justify-between">
                        <div>
                            <ImageIcon className="h-10 w-10 text-primary mb-6" />
                            <h2 className="text-3xl font-bold mb-4">{t('press.imagery.title')}</h2>
                            <p className="text-muted-foreground mb-8 text-lg">{t('press.imagery.desc')}</p>
                        </div>
                        <Button variant="link" className="text-primary font-bold p-0 justify-start text-lg">
                            {t('press.imagery.btn')}
                        </Button>
                ...
                <section className="text-center p-12 bg-primary rounded-4xl text-white">
                    <h2 className="text-3xl font-bold mb-4">{t('press.inquiries.title')}</h2>
                    <p className="text-white/70 mb-8 max-w-xl mx-auto">{t('press.inquiries.desc')}</p>
